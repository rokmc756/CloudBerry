...
cbdb:
	make -f configs/Makefile.cbdb r=${r} s=${s} c=${c} USERNAME=${USERNAME}

pgb:
	make -f configs/Makefile.pgbouncer r=${r} s=${s} c=${c} USERNAME=${USERNAME}

pxf:
	make -f configs/Makefile.pxf r=${r} s=${s} c=${c} USERNAME=${USERNAME}
